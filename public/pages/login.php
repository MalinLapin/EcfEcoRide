    ...
    <div class="card">
        ...
        <form method="POST" action="#">
            <div class="form-group">
                <label for="pseudo robotoRegular"><i class="fas fa-envelope form-icon"></i>Pseudo :</label>
                <input type="text" id="pseudo" name="pseudo" placeholder="Votre pseudo" required>
            </div>
            <div class="form-group">
                <label for="password robotoRegular"><i class="fas fa-lock form-icon"></i>Mot de passe :</label>
