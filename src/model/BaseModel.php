...
abstract class BaseModel
{
    ...
    private array $intFields =['id_brand', 'id_car', 'id_user', 'idRedactor', 'idTarget','idParticipation', 'id_ridesharing', 'available_seats', 'price_per_seat', 'id_driver', 'credit_balance', 'rating', 'reviewedBy'];
